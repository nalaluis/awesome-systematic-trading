...
#
# Personal notes:
#   - Increased coarse_count from 500 to 1000 to better approximate the original "top 30%" universe described in the paper.
#   - A larger universe should improve the decile spread and reduce single-stock concentration risk.
...
class Month12CycleinCrossSectionofStocksReturns(QCAlgorithm):
    ...
    def Initialize(self):
        ...
        # Increased from 500 to 1000 to capture a broader universe closer to the paper's top 30% criterion.
